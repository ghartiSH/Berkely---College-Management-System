<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Student-Fee.aspx.cs" Inherits="Berkeley.Student_Fee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <h1 class="underline">Student - Fee</h1>
    </div>
    <div class="jumbotron">
        ...
        <div class="tablecss">
            <h2 class="underline">Details of Students and their Fee Status:</h2>
